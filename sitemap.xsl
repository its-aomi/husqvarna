	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'700'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap &#x2d; Husqvarna Adventure</title>
...
<meta name="msapplication-TileImage" content="http://localhost/japan/wp-content/uploads/2022/09/favicon-hus.png" />
			...
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="http://localhost/japan"><h1>Husqvarna Adventure — XML Sitemap</h1></a>
<p>
